...
\begin{figure}
\noindent\includegraphics[width=0.9\textwidth]{figure/Zhang2022/Linear_TRM_test.pdf}
\centering
...
\resizebox{0.8\textwidth}{!}{\begin{tabular}{p{0.6cm}p{1.2cm}p{0.6cm}p{0.6cm}p{0.6cm}p{0.4cm}p{0.8cm} c c p{0.6cm}p{0.6cm}p{1cm}p{1cm}p{1cm} c c p {0.8cm}}
\hline
